...
for i in range(10):
    ...
    if method == 'RF':
        ...
        clf = MLPClassifier(hidden_layer_sizes=(602,), activation='logistic', solver='lbfgs', max_iter=596,
        ...
        clf = DecisionTreeClassifier(criterion='entropy', splitter='best', max_depth=394, min_samples_split=489,
                                     min_samples_leaf=39, ccp_alpha=0.3489472)

    elif method == 'SVM':
        clf = LinearSVC(penalty='l2', loss='squared_hinge', dual=False, C=6.297360, max_iter=1159)

    elif method == 'NB':
        clf = GaussianNB(var_smoothing=1.7240426e-06)
